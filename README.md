...
## Setup
  * If not done yet, install an IDE of your choice for Java ([IntelliJ IDEA](https://www.jetbrains.com/de-de/idea/download/#section=windows) is recommended for proper funcion) 
  * Make sure to use Java SE 17 or a higher version for proper function:
    ...
    * Under "Project" choose in SDK the one to use 
